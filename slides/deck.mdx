...
import {  CodeSurferLayout,  CodeSurferColumnLayout,  Code,  Step,  oceanicNext,} from 'code-surfer';


export const themes = [oceanicNext,ionic];
...
<CodeSurferLayout>
  ...
  <Code focus="19" subtitle="H4x0r m0v3: change the builder name 🙃" lang="typescript" code={ require('!!raw-loader!../custom-builder/builders/custom-guess-build/index.ts').default}/>
